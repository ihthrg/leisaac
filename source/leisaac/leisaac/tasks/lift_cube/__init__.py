...
gym.register(
    id="LeIsaac-SO101-LiftCubePickPlace-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.lift_cube_pick_place_env_cfg:LiftCubePickPlaceEnvCfg",
    },
)

gym.register(
    id="LeIsaac-SO101-LiftCubePickPlace-Mimic-v0",
    entry_point="leisaac.enhance.envs:ManagerBasedRLLeIsaacMimicEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.lift_cube_pick_place_mimic_env_cfg:LiftCubePickPlaceMimicEnvCfg",
    },
)
